...
ALL_SETTINGS = [  # [名称, 默认值, 是否在尝试修复时重置, 简介]
    ...
    ["CDN_PREV", "https://jsdelivr.pai233.top/npm/", True, "调用NPM的CDN前缀"],
    ...
    ["INIT", "2", False, "初始化标识"],
    ["QEXO_ICON",
     "https://jsdelivr.pai233.top/npm/qexo-static@1.4.0/assets/img/brand/favicon.ico",
     False, "站点ICON"],
    ["QEXO_LOGO",
     "https://jsdelivr.pai233.top/npm/qexo-static@1.4.0/assets/img/brand/qexo.png",
     False, "站点LOGO"],
